                                                    ...
                                                    <ul className="sm:w-56">
                                                        <li>
                                                            <div className="flex items-center px-4 py-2">
                                                                ...
                                                                <div className="flex-1 truncate">{selectedMail.type === 'sent_mail' ? 'COMPANYNAME@gmail.com' : selectedMail.email}</div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="flex items-center px-4 py-2">
                                                                <div className="w-1/4 text-white-dark ltr:mr-2 rtl:ml-2">To:</div>
                                                                <div className="flex-1 truncate">{selectedMail.type !== 'sent_mail' ? 'COMPANY_NAME@gmail.com' : selectedMail.email}</div>
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="flex items-center px-4 py-2">
